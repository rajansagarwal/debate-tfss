...
export default function exec() {
    ...
    return (
        <div>
        <link rel="stylesheet" href="/styles/exec.css" />

    <head>

        <div id="ExecutiveTitle">
            <div id="ExecutiveTitleFont">
                <h1> Executive Team </h1>
            </div>

            <div id="ExecutiveSubTitleFont">
                
                <p> Your 2023 Executive Team to Guide Your Journey in Debate </p>
            </div>
            
            <div id="ViewExecButton">
                <button id="window.location.href='#down'"> <p>View Your 2023 Execs</p></button>
            
                {title_headers("Presidents")}

                <div id="executive-grid-container">
                    <div id="grid-president1">
                        <h2> Jeevan Brar </h2>
                        <div id="grid-text">
                        ...
                        <div id="grid-text">
                            ...
                            <div id="text">
                                <p>Japnam is leading the exceutive team to make sure that the 2022/2023 chapter is the best chapter yet. 
                                    ...
                                    aims to encourage debate and the exploration of the truth throughout TFSS this year!
                                 </p>
                            </div>
                            {grid_picture}
                        </div>
